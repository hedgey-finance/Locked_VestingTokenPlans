...
import '../FVotingTokenLockupPlans.sol';
...
contract FVotingTokenLockupPlans_Bound is FVotingTokenLockupPlans {
  constructor(string memory name, string memory symbol) FVotingTokenLockupPlans(name, symbol) {}
